...
# Publication type (Updated to CSL standard)
# 'article-journal' corresponds to Journal Article
...
# Featured (Crucial for home page display)
featured: true

# Links (Using new syntax, but url_pdf usually still works too)
url_pdf: "paper.pdf"
