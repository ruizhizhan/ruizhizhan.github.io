title: "Novel Atmospheric Dynamics Shape the Inner Edge of the Habitable Zone around White Dwarfs"

# 作者列表 (对应 content/authors/ 下的文件夹名，me 代表你自己)
authors:
- me
- "Daniel D. B. Koll"
- "Feng Ding"
...
doi: "https://doi.org/10.3847/1538-4357/ad54c1"
...
# -----------------------------------------------------------
# 重要：必须设置为 true，因为你的 block 设置了 featured_only: true
# 只有设置为 true 的文章才会显示在首页这个位置！
featured: true
# -----------------------------------------------------------

# 链接按钮 (对应文件夹内的文件)
url_pdf: "paper.pdf"
# url_code: "https://github.com/yourname/project"
url_dataset: ""
url_poster: ""
url_project: ""
url_slides: ""
