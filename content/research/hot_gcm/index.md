---
title: Modeling Pipeline for Hot Rocky Exoplanets
type: page
summary: Building non-grey GCM simulations for hot rocky exoplanets with high-temperature opacity data and custom correlated-k coefficients.
tags:
  - Exoplanets
  - GCM
...
<div style="display: flex; flex-wrap: wrap; gap: 0.75rem; margin-top: 3rem;">
  ...
  <a href="/research/55cnce/" style="align-items: center; border: 1px solid currentColor; border-radius: 8px; display: inline-flex; font-weight: 700; gap: 0.45rem; padding: 0.7rem 1rem; text-decoration: none;">55 Cancri e Case Study</a>
</div>
